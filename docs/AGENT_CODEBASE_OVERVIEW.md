...
| [`PLAN_SOC_FIELD_TEST_BACKLOG.md`](PLAN_SOC_FIELD_TEST_BACKLOG.md) | Post-SOC-6 soccer field-test backlog. Owner-confirmed through `S18` (sideline layout, default role, Timeline shot edit, opponent-actor lock, finalize mismatch, header, placement, corner taker/side, upside-down flip counts). Do not implement from the backlog; expand one confirmed item at a time |
