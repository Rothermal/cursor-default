...
projection remains fail-closed. `REGRESSION_SOC_RESTARTS.md` owns the deployed
browser/PWA, live Supabase, cached-reader, and local-only evidence; those
