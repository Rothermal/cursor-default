...
| [`PLAN_SOC_FIELD_TEST_BACKLOG.md`](PLAN_SOC_FIELD_TEST_BACKLOG.md) | Post-SOC-6 soccer field-test issues (`S*`) and reserved future modules (`M*`); waiting for owner match-note confirmation before planning |
