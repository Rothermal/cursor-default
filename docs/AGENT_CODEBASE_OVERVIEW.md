...
| [`PLAN_BKE_6C_LIVE_LINEUPS_AND_CORRECTIONS.md`](PLAN_BKE_6C_LIVE_LINEUPS_AND_CORRECTIONS.md) / [`REGRESSION_BKE_6C1_LIVE_SUBSTITUTIONS.md`](REGRESSION_BKE_6C1_LIVE_SUBSTITUTIONS.md) / [`REGRESSION_BKE_6C2_BOUNDARY_EQUAL_PLAY.md`](REGRESSION_BKE_6C2_BOUNDARY_EQUAL_PLAY.md) / [`REGRESSION_BKE_6C3_ROLES_AND_RECOVERY.md`](REGRESSION_BKE_6C3_ROLES_AND_RECOVERY.md) | Approved BKE-6C1 through BKE-6C4 plan: live substitutions, boundary/equal-play review, and roles/current-lineup recovery are implemented; grouped correction/exit is next |
