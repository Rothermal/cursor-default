...
adjustments. SOC-4 planning is complete: SOC-4A adds the remaining event domain,
SOC-4B adds normal-match capture and review, and SOC-4C adds shootouts and structured
outcomes. No SOC-4 runtime behavior has shipped yet.
...
| [`PLAN_SOC_4_MATCH_EVENT_CATALOG.md`](PLAN_SOC_4_MATCH_EVENT_CATALOG.md) / [`PLAN_SOC_0_SOCCER_PRODUCT_MODEL.md`](PLAN_SOC_0_SOCCER_PRODUCT_MODEL.md) | SOC-3 complete; SOC-4 plan reviewed; SOC-4A match event domain is next |
