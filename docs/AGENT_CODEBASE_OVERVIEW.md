...
BKE-6D1 is next. BKE-6E retains release-entry evidence and the broader live matrix.
...
| [`PLAN_BKE_6D_CLOUD_SUMMARY_AND_AGGREGATES.md`](PLAN_BKE_6D_CLOUD_SUMMARY_AND_AGGREGATES.md) | Approved BKE-6D1 through BKE-6D4 plan for anchored Summary detail, exact-second aggregates, dual-capability recorder transport, trusted finalization, mode-aware reopen, and explicit republication; BKE-6D1 is next |
