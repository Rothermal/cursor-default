...
| [`supabase/migrations/`](../supabase/migrations/) | Schema source of truth (001-046) | Any DB change |
...
| Item | Detail |
|------|--------|
| Migrations | 46 files (`001`-`046`) in [`supabase/migrations/`](../supabase/migrations/) |
...
| [`PLAN_SOC_6_SUMMARY_AND_RELEASE.md`](PLAN_SOC_6_SUMMARY_AND_RELEASE.md) / [`PLAN_SOC_6A_SUMMARY_FOUNDATION.md`](PLAN_SOC_6A_SUMMARY_FOUNDATION.md) / [`PLAN_SOC_6B_DETAILED_MATCH_REVIEW.md`](PLAN_SOC_6B_DETAILED_MATCH_REVIEW.md) | SOC-6A Overview and all SOC-6B detailed match-review slices shipped; SOC-6C canonical aggregates are next |
| [`PLAN_BASKETBALL_EVENT_MODEL_ROADMAP.md`](PLAN_BASKETBALL_EVENT_MODEL_ROADMAP.md) / [`PLAN_BKE_0_BASKETBALL_EVENT_ARCHITECTURE.md`](PLAN_BKE_0_BASKETBALL_EVENT_ARCHITECTURE.md) | Basketball migration onto the shared event model. BKE-0 architecture plan drafted and awaiting review; BKE-1 through BKE-5 are gated on that approval |
