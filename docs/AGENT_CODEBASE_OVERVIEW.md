...
BKE-6B4 through BKE-6E remain; rules versions 1-2, setup version 1, and existing games remain
...
| [`PLAN_BKE_6B_PRODUCTION_SETUP_AND_CLOCK.md`](PLAN_BKE_6B_PRODUCTION_SETUP_AND_CLOCK.md) | Detailed BKE-6B1 through BKE-6B4 plan; B1 contracts, B2 guarded local setup/opening-lineup workflow, and B3 canonical live clock are implemented; B4 parking/period-flow exit remains |
| [`REGRESSION_BKE_6B1_CLOCK_SETUP_CONTRACTS.md`](REGRESSION_BKE_6B1_CLOCK_SETUP_CONTRACTS.md) / [`REGRESSION_BKE_6B2_ANCHORED_SETUP.md`](REGRESSION_BKE_6B2_ANCHORED_SETUP.md) / [`REGRESSION_BKE_6B3_LIVE_CLOCK.md`](REGRESSION_BKE_6B3_LIVE_CLOCK.md) | BKE-6B1 device/settings/draft policy, BKE-6B2 guarded setup-v2 start, and BKE-6B3 canonical live-clock evidence |
