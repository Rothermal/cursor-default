...
Soccer S23A/S23B extend the team-settings foundation and Team Manage. Current logical team
...
roster datasets load. S23C owns one-time Player Setup consumption; no current
live match behavior uses the stored defaults yet. See
`docs/REGRESSION_SOC_S23A_LINEUP_SETTINGS.md` and
`docs/REGRESSION_SOC_S23B_LINEUP_EDITOR.md`.
