...
Soccer Restarts R1-R3 widen the existing version-1 `soccer.team_event` reader to
...
projection remains fail-closed. R4 owns regression closure and deployed checks.
