...
adjustments. SOC-4 is the next soccer phase.
...
| [`PLAN_SOC_3_FIELD_AND_ATTACKING_EVENTS.md`](PLAN_SOC_3_FIELD_AND_ATTACKING_EVENTS.md) / [`PLAN_SOC_0_SOCCER_PRODUCT_MODEL.md`](PLAN_SOC_0_SOCCER_PRODUCT_MODEL.md) | SOC-3 complete; SOC-4 defensive, discipline, and team events is next |
