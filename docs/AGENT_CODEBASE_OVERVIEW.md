...
and reasoned current-lineup recovery; see `REGRESSION_BKE_6C3_ROLES_AND_RECOVERY.md`. BKE-6C4 next
owns grouped correction/exit. BKE-6D and BKE-6E remain; rules versions 1-2, setup version 1, and existing games remain
