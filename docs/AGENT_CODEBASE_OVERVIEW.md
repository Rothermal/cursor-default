...
`REGRESSION_BKE_6C4_LINEUP_CORRECTIONS.md`. BKE-6C is complete. BKE-6D and BKE-6E remain; rules versions 1-2, setup version 1, and existing games remain
...
preserving running sync, strict adoption, recovery uploads, and quarantine. BKE-6D4 adds trusted
anchored readiness and mode-aware Correct records/Resume game reopen behind additive fixed wrappers;
existing RPC shapes, canonical versions, Soccer, and old mode-less reopen behavior stay unchanged.
...
activation, strict adoption, stale-account guards, and no migration. BKE-6D4 is next; BKE-6E
...
| [`PLAN_BKE_6D_CLOUD_SUMMARY_AND_AGGREGATES.md`](PLAN_BKE_6D_CLOUD_SUMMARY_AND_AGGREGATES.md) / [`REGRESSION_BKE_6D1_SUMMARY_DETAIL.md`](REGRESSION_BKE_6D1_SUMMARY_DETAIL.md) / [`REGRESSION_BKE_6D2_EXACT_AGGREGATES.md`](REGRESSION_BKE_6D2_EXACT_AGGREGATES.md) / [`REGRESSION_BKE_6D3_ANCHORED_CLOUD_TRANSPORT.md`](REGRESSION_BKE_6D3_ANCHORED_CLOUD_TRANSPORT.md) | Approved BKE-6D1 through BKE-6D4 plan; BKE-6D1 Summary detail, BKE-6D2 exact aggregates, and BKE-6D3 anchored transport are complete. BKE-6D4 is next |
