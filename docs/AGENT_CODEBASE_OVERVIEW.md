...
| [`PLAN_SOC_FIELD_TEST_BACKLOG.md`](PLAN_SOC_FIELD_TEST_BACKLOG.md) | Post-SOC-6 soccer field-test backlog. Owner-confirmed: `S2`/`S3` sideline layout, `S11` default player role, `S12` Timeline shot edit, `S13` opponent-actor quarantine, `S14` finalize checkpoint mismatch, `S15` header goals, `S16` goal-mouth / shot placement. Do not implement from the backlog; expand one confirmed item at a time |
