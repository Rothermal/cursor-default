...
SOC-4B adds normal-match capture and review, and SOC-4C exposes shootouts and structured
outcomes.
...
| [`PLAN_SOC_4_MATCH_EVENT_CATALOG.md`](PLAN_SOC_4_MATCH_EVENT_CATALOG.md) / [`PLAN_SOC_0_SOCCER_PRODUCT_MODEL.md`](PLAN_SOC_0_SOCCER_PRODUCT_MODEL.md) | SOC-4A domain complete pending review; SOC-4B normal-match capture is next after merge |
