...
gating; see `REGRESSION_BKE_6C2_BOUNDARY_EQUAL_PLAY.md`. BKE-6C3 next owns roles/current-lineup recovery, then grouped
...
| [`PLAN_BKE_6C_LIVE_LINEUPS_AND_CORRECTIONS.md`](PLAN_BKE_6C_LIVE_LINEUPS_AND_CORRECTIONS.md) / [`REGRESSION_BKE_6C1_LIVE_SUBSTITUTIONS.md`](REGRESSION_BKE_6C1_LIVE_SUBSTITUTIONS.md) / [`REGRESSION_BKE_6C2_BOUNDARY_EQUAL_PLAY.md`](REGRESSION_BKE_6C2_BOUNDARY_EQUAL_PLAY.md) | Approved BKE-6C1 through BKE-6C4 plan: live substitutions and boundary/equal-play review are implemented; roles/recovery is next, followed by correction/exit |
