...
- [x] **Soccer live lineup manager (S24)** - S24A-S24D are implemented and migration 069 is applied: setup v2 and frozen Team Default, atomic target transitions, halftime/count/interval validation, stale-preview rejection, the live two-column manager with presets and short-handed confirmation, and grouped Timeline/Summary review and historical correction. Deployed owner regression remains pending ([plan](../../docs/PLAN_SOC_S24_LIVE_LINEUP_MANAGER.md), [S24A regression](../../docs/REGRESSION_SOC_S24A_FROZEN_PRESET.md), [S24B regression](../../docs/REGRESSION_SOC_S24B_TARGET_TRANSITION.md), [S24C regression](../../docs/REGRESSION_SOC_S24C_LINEUP_MANAGER.md), [S24D regression](../../docs/REGRESSION_SOC_S24D_LINEUP_TIMELINE.md))
...
- [x] **Basketball release audit and consolidated matrix (BKE-6E1)** - enforced release-policy consumer inventory plus mapped capability, existing-record, Legacy/clockless, Soccer, and mixed-sport evidence in one operator record with no runtime or migration change ([plan](../../docs/PLAN_BKE_6E_RELEASE_HARDENING.md), [release matrix](../../docs/REGRESSION_BKE_6E_RELEASE.md))
- [x] **Basketball release-surface hardening (BKE-6E2)** - exact deployed build identity, controlled PWA update/reload protection, compact/safe-area/reduced-motion and critical focus hardening, plus repeatable browser/PWA/recovery/rollback procedures with exact deployed evidence retained for BKE-6E3 ([plan](../../docs/PLAN_BKE_6E_RELEASE_HARDENING.md), [release matrix](../../docs/REGRESSION_BKE_6E_RELEASE.md))
