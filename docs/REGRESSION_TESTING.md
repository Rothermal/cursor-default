...
| 9.16 | `/career` (basketball, player with FT/2PT/3PT stats) | **Career totals** uses category tables like game summary: **FT M/A** (or 2PT/3PT) shows made/attempts + %; **Per game** row; **Best game** row |
