...
| 3a.18 | Park a dirty cloud-bound game A, start/open another local game B, then Cloud Games/Settings Advanced → Delete game A (or its team) | Delete is blocked with an unsynced-local message; parked A remains; cloud row is not deleted |
