...
**Related docs:** [DESIGN_NAVIGATION_SEASONS_TOURNAMENTS.md](DESIGN_NAVIGATION_SEASONS_TOURNAMENTS.md), [DESIGN_SEASONS_DATA_MODEL.md](DESIGN_SEASONS_DATA_MODEL.md), [DESIGN_STAT_TRACKING_UI.md](DESIGN_STAT_TRACKING_UI.md), [INTEGRATION_PLAN.md](INTEGRATION_PLAN.md).
