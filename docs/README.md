...
| Football program | [FBE-0 product model](PLAN_FBE_0_FOOTBALL_PRODUCT_MODEL.md) with [FBE-1](PLAN_FBE_1_ROSTER_POSITIONS_AND_UNITS.md), [FBE-2](PLAN_FBE_2_PLAY_EVENT_MODEL.md), [FBE-3](PLAN_FBE_3_FIELD_AND_LIVE_CAPTURE.md) | Proposed plans; owner Q&A pending; no code |
