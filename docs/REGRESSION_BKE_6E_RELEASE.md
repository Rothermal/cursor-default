...
| Run 1: Entry and local authority | Blocked | Core setup/capture/correction and running-clock pause safety passed. Replacement setup continuity failed in [issue #352](https://github.com/Rothermal/cursor-default/issues/352). Completion reached Summary, which reported unresolved tracked-lineup boundary authority; [issue #353](https://github.com/Rothermal/cursor-default/issues/353) was diagnosed as a skipped review (End Period on a never-started period) and fixed by [PR #427](https://github.com/Rothermal/cursor-default/pull/427); re-run C04. #352 remains open. |
...
| C04 | Exercise changed-five and equal-play-off/advisory/enforced boundaries | Review and reasoned override rules match the immutable profile and current lineup | E3 owner smoke | Re-run required. The earlier failure (`Tracked lineup requires boundary review` in Summary) was a skipped review: ending a period whose clock never started bypassed the Start-only gate, and a closed period's boundary cannot be confirmed. [PR #427](https://github.com/Rothermal/cursor-default/pull/427) makes End Period open boundary review first; [issue #353](https://github.com/Rothermal/cursor-default/issues/353). |
