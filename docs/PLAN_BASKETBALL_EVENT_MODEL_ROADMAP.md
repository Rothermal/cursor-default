...
BKE-1A, all BKE-1B slices, and all BKE-1C slices are complete. The existing Basketball court now
round-trips through checked local events with grouped correction parity; BKE-2 direct live actions
are next.
