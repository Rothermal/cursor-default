...
| SOC-5 | Cloud sync, independent recorder streams, primary resolution, finalization, and resume hardening ([detailed plan](PLAN_SOC_5_CLOUD_SYNC_AND_FINALIZATION.md)) | SOC-5A transport implemented; SOC-5B-D complete resume, conflicts, recorder resolution, and finalization |
