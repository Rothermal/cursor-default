...
Status: THM-1, THM-2, and THM-3A/B/C implemented; THM-3D and THM-4 through THM-6 pending
...
imported review panels. Statistics destinations (THM-3D) remain pending.
