...
- [ ] **Soccer SOC-6E2 sign-off/SOC-6E3** - record the two preliminary operator passes, then flip the centralized opt-in production release flag and run final deployed sign-off; production Soccer discovery remains off until SOC-6E3 ([release matrix](docs/REGRESSION_SOC_6E_RELEASE.md), [SOC-6 plan](docs/PLAN_SOC_6_SUMMARY_AND_RELEASE.md))
