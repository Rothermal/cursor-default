...
- [ ] **Soccer team lineup defaults (S23)** - S23A/S23B implement sparse stable-player starter ids, team settings schema-v3 compatibility, migration 068 validation, the role-ordered Team Manage editor, dual-readiness stale cleanup, and read-only review; one-time Player Setup consumption remains S23C ([plan](docs/PLAN_SOC_S23_LINEUP_STATUS_DEFAULTS.md), [S23A regression](docs/REGRESSION_SOC_S23A_LINEUP_SETTINGS.md), [S23B regression](docs/REGRESSION_SOC_S23B_LINEUP_EDITOR.md))
