...
- [ ] **Court capture polish** — F5 shot-value override and F6 in-popup player switching are implemented; F12/F7 are planned next slices for recent-events undo and assist-linking; F8-F11 remain roadmap sketches ([roadmap](docs/PLAN_COURT_CAPTURE_ENHANCEMENTS_ROADMAP.md))
