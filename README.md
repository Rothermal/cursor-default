...
- [ ] **Basketball event-model migration (BKE-1B through BKE-6)** — BKE-0 and BKE-1A are complete; next plan the Basketball setup, participant, event-definition, projector, and parity-fixture foundation in BKE-1B ([roadmap](docs/PLAN_BASKETBALL_EVENT_MODEL_ROADMAP.md), [BKE-1 parent](docs/PLAN_BKE_1_EVENT_FOUNDATION_AND_COURT.md))
