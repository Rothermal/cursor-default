...
- [ ] **Soccer SOC-6C4 through SOC-6E** - add player/career aggregates, settings/defaults, regression QA, and production release ([SOC-6 plan](docs/PLAN_SOC_6_SUMMARY_AND_RELEASE.md), [SOC-6C plan](docs/PLAN_SOC_6C_CANONICAL_AGGREGATES.md), [roadmap](docs/PLAN_SOC_0_SOCCER_PRODUCT_MODEL.md))
