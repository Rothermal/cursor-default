...
- [ ] **Court capture polish** — F5 shot-value override, F6 in-popup player switching, and F12 recent-events undo are implemented; F7 assist-linking is the next planned slice; F8-F11 remain roadmap sketches ([roadmap](docs/PLAN_COURT_CAPTURE_ENHANCEMENTS_ROADMAP.md))
