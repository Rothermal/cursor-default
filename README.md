...
- [ ] **Soccer SOC-6B2 through SOC-6E** - add detailed Timeline, Field, and Shootout review, canonical aggregates, settings/defaults, regression QA, and production release ([SOC-6 plan](docs/PLAN_SOC_6_SUMMARY_AND_RELEASE.md), [SOC-6B plan](docs/PLAN_SOC_6B_DETAILED_MATCH_REVIEW.md), [roadmap](docs/PLAN_SOC_0_SOCCER_PRODUCT_MODEL.md))
