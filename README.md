...
- [ ] **Soccer match event capture (SOC-4B through SOC-4C)** - normal-match defense/discipline/team capture followed by the shootout/outcome workspace ([plan](docs/PLAN_SOC_4_MATCH_EVENT_CATALOG.md))
