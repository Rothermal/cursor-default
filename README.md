...
- [ ] **Basketball clock/lineup foundation (BKE-6A)** - detailed into three implementation slices for strict rules/setup, clock events/projection, and lineup/equal-play projection without production UI ([plan](docs/PLAN_BKE_6A_CLOCK_LINEUP_FOUNDATION.md))
