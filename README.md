...
- [x] **Basketball event Timeline and read-only detail (BKE-3A)** - Track/Timeline workspace, filtered capture groups, revision/removal diagnostics, shared event/legacy shot detail, and safe overlap-aware marker selection ([plan](docs/PLAN_BKE_3_EVENT_TIMELINE_AND_F13.md))
- [ ] **Basketball event Timeline and F13 (BKE-3)** - approved BKE-3A through BKE-3D plan for event review, detail editing, remove/restore, relationships, and historical additions ([plan](docs/PLAN_BKE_3_EVENT_TIMELINE_AND_F13.md))
