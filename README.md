...
- [ ] **Soccer team lineup defaults (S23)** - S23A implements sparse stable-player starter ids, team settings schema-v3 compatibility, dual-readiness cleanup preparation, migration 068 validation, and coarse audit metadata; Team Manage editing and one-time Player Setup consumption remain S23B/S23C ([plan](docs/PLAN_SOC_S23_LINEUP_STATUS_DEFAULTS.md), [S23A regression](docs/REGRESSION_SOC_S23A_LINEUP_SETTINGS.md))
