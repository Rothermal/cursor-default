...
- [ ] **Basketball canonical aggregates and release readiness (BKE-4E)** - approved in five slices covering mixed legacy/canonical history, paginated source transport, all aggregate destinations, capability negotiation, and release evidence ([plan](docs/PLAN_BKE_4E_AGGREGATES_AND_RELEASE_READINESS.md))
