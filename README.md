...
- [ ] **Basketball event-model migration (BKE-1B2 through BKE-6)** — BKE-1B1 establishes state and lifecycle; next add shooting, scoring, possession, and stat projection in BKE-1B2 while the runtime gate remains closed ([roadmap](docs/PLAN_BASKETBALL_EVENT_MODEL_ROADMAP.md), [BKE-1B plan](docs/PLAN_BKE_1B_BASKETBALL_EVENT_FOUNDATION.md))
