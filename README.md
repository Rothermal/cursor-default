...
├── PLAN_MULTI_GAME_PARKING.md # Roadmap: local parking shipped; sync queue next
...
- [ ] **Multi-game sync queue P1** — dirty tracking and ordered cloud sync for all parked games, including offline drain ([plan](docs/PLAN_MULTI_GAME_PARKING.md))
