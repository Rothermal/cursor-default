...
- [ ] **Soccer implementation (SOC-3 through SOC-6)** - soccer field and attacking events, defense/discipline/team events, cloud sync, summaries, and release ([roadmap](docs/PLAN_SOC_0_SOCCER_PRODUCT_MODEL.md))
