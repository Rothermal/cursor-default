...
- [ ] **Basketball event-model migration (BKE-1B3 through BKE-6)** — BKE-1B1/BKE-1B2 establish lifecycle and stat projection; next add fouls, ejections, timeouts, minutes, durable authority quarantine, complete parity, and internal runtime registration in BKE-1B3 ([roadmap](docs/PLAN_BASKETBALL_EVENT_MODEL_ROADMAP.md), [BKE-1B plan](docs/PLAN_BKE_1B_BASKETBALL_EVENT_FOUNDATION.md))
