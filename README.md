...
- [ ] **Basketball setup authority and binding policy (BKE-5C)** - four-slice mutation-free setup plan covering reload-safe drafts, atomic commit, exact rule freeze, durable local-only policy, and guarded later cloud binding ([plan](docs/PLAN_BKE_5C_SETUP_AUTHORITY_AND_BINDING.md))
