...
- [ ] **Soccer SOC-6D3 through SOC-6E** - add team/setup inheritance, release hardening, and opt-in production discovery ([SOC-6 plan](docs/PLAN_SOC_6_SUMMARY_AND_RELEASE.md), [SOC-6D plan](docs/PLAN_SOC_6D_SOCCER_SETTINGS.md), [roadmap](docs/PLAN_SOC_0_SOCCER_PRODUCT_MODEL.md))
