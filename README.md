...
- [ ] **Court capture polish** — F5 shot-value override is implemented; F6/F12/F7 are planned next slices for in-popup player switching, recent-events undo, and assist-linking; F8-F11 remain roadmap sketches ([roadmap](docs/PLAN_COURT_CAPTURE_ENHANCEMENTS_ROADMAP.md))
