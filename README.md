...
- [ ] **Basketball event Timeline and F13 (BKE-3)** - revisioned event review, detail editing, remove/restore, and linked Basketball event correction ([roadmap](docs/PLAN_BASKETBALL_EVENT_MODEL_ROADMAP.md))
- [ ] **Basketball event-model migration (BKE-3 through BKE-6)** - editable Timeline/F13, cloud lifecycle and aggregates, settings/rollout, then clock and lineups ([roadmap](docs/PLAN_BASKETBALL_EVENT_MODEL_ROADMAP.md))
