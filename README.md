...
- [ ] **Basketball live anchored clock (BKE-6B3)** - one canonical command-time path, sticky Track/Timeline controls, Start/Pause/Set Clock, expiration, and reload recovery ([plan](docs/PLAN_BKE_6B_PRODUCTION_SETUP_AND_CLOCK.md))
